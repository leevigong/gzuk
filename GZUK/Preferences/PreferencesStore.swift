...
final class PreferencesStore {
    ...
    private(set) var showShortcutHints: Bool
    ...
    private enum Keys {
        ...
        static let showShortcutHints = "GZUK.showShortcutHints"
    }
    ...
    func setShowShortcutHints(_ value: Bool) {
        showShortcutHints = value
        defaults.set(value, forKey: Keys.showShortcutHints)
    }
}
